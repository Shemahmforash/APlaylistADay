...
$t->get_ok('/playlist')->status_is(200)->element_exists('html body div.container div.row div.col-sm-6 div.media div.media-body', 'At least one event besides playlist');
